...
public class LojaControllerTest {
	...
	public void setUp() throws Exception {
		...
		meuSistema.vendeJogo("Final Fantasy", 30, "OFFLINE COOPERATIVO", "RPG", "Tsubakker");
		meuSistema.vendeJogo("Tsubakker", gdw);
		meuSistema.vendeJogo("Tsubakker", tkf);
		meuSistema.vendeJogo("Tsubakker", crashb);
		meuSistema.vendeJogo("Tsubakker", mortalKombat);
		meuSistema.vendeJogo("Tsubakker", sony);
		
		meuSistema.vendeJogo("SLNSN", mario);
	...
	public void testvendeJogoWithException() throws Exception{
		...
		try {
			meuSistema.vendeJogo("Tsubakker", null);
			fail();
		}catch(Exception e) {
		...
		try {
			meuSistema.vendeJogo("", clearWave);
			fail();
		}catch(Exception e) {
			assertEquals("Login de usuario nao pode ser vazio ou nulo.", e.getMessage());
		}
		...
		try {
			meuSistema.vendeJogo(null, clearWave);
			fail();
		}catch(Exception e) {
			assertEquals("Login de usuario nao pode ser vazio ou nulo.", e.getMessage());
		}
	...
	public void testUpgrade() throws ValidacaoException {
		...
		meuSistema.vendeJogo("SLNSN", sonyr);
		meuSistema.vendeJogo("SLNSN", tw3);
		...
		meuSistema.vendeJogo("SLNSN", new Plataforma("Mega", 1));
